...
## portfolio-opdrachten
 ...
 - Begin op tijd. Deadline is niet morgen, maar ze moeten wel straks allemaal in je portfolio...
 - Maak voor elke portfolio-opdracht een nieuwe .Rmd file.
 - werk in je _portfolio project voor de portfolio-opdrachten
 - maar niet voor de les-opdrachten.
 
 
## portfolio-opdracht reproducible science

 - lees na de lunch allemaal de portfolio-opdracht
 - kies een paper uit
 - stem met elkaar af dat je niet hetzelfde paper kiest. (schrijf bijv pmid op het whiteboard of in teams)
