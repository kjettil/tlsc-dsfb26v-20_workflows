...
## Exam
The credits for this course can be earned by handing in the final exam assignment. The details are described here \@ref(exam). In short: In your own personal github account you will need to setup a github pages page. This page will function as a portfolio where you will post all the assignements and output products of the course. For details on github-pages [see:](https://pages.github.com/)  
