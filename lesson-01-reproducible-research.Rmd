...
At the end of every lesson, there is a larger _lesson assignment_ (dagopdracht). You will work on this assignment for the rest of the day, after finishing the smaller exercises in the lesson. Save all lesson assignments in separate Rmd files (as instructed within the assignments). Please create a separate RStudio project to complete all the lesson assignments. The colleaction of all the lesson assignments, plus the work you do for the projecticum will form your portfolio for this course. The portfolio is also the exam for this course. **You will need to pass all lesson assignments in order to pass the course**. See \@ref(portfolioexam) for more info. 
