...
<div class="question">
##### Exercise 1.2
Imagine you recieve a file attached to an email called: 
...
Describe the following steps in an RMarkdown file. You do not need to write the R code for the actual analysis at this point - we will do that later in another exercise in this lesson. Save the 
 ...
 1. Write a conceptual reply email to the researcher, where you address the changes that the researcher needs to make to the file in order for you to be able to analyze this data in R.
...
<div class="question">
## EXERCISE 1. Guerilla analytics {-}
 
 1. Look at you RStudio project that you created for the DAUR-II final assignment
 1. Rearrange your project according the Guerilla principles explained above
 1. Ad README files to the datasets 
 1. Use the `{fs}` pacakge to share a screeshot of your folder tree, look [at:]() for more info on how to use the `{fs}` package. 
