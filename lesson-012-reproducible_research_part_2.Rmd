# Lesson 1 - Part 2 - Managing your (data) projects with 'Guerrilla Analytics' {#reproducibleresearch2}
...
## GA Principle 4: Link stored data, to data in the analytics environment, to data in work products
...
## GA Principle 5: Version control for data and code - Git/Github {.build}
...
## GA Principle 6: Consolidate team knowledge 
...
## GA Principle 7: Prefer analytics code that runs from start to finish
...
Look at you RStudio project that you created for the DAUR-II final assignment
