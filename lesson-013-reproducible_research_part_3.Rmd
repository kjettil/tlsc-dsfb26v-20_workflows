...
```
 ...
 4. Update conda and all packages using:  
 ...
 ```
 I
 4. Create an new conda environment using this command
 
 ```
 conda create -n qimme2
 ```
 
 5. Qiime is a workflow for analyzing metagenomics (16S and Amplicon sequencing). You can use conda to characterize and classify microbial composition of samples. Let's install the `qiime2` workflow in our new `qimme2` conda environment
