...
<a href="https://github.com/DataScienceILC/tlsc-dsfb26v-20_workflows/raw/main/data/toxrefdb_nel_lel_noael_loael_summary_AUG2014_FOR_PUBLIC_RELEASE.csv" download> Download a new datafile here.</a>
...
```
 ...
 (b) Upload the file to the [server](https://datascience.hu.nl/rstudio/tlsc-dsfb16v-20-21/) and check again. Again, save the resulting md5sums in a file. Do the md5sums you calculated on the server and the md5sums of the local file match?
...
Read this paragraph header again and make sure you understand the difference between "stored data", "data in the analytics environdment" and "data in work products".
...
```{r, dpi = 30, echo=FALSE, fig.cap="A short example of a README.txt file"}
knitr::include_graphics(
  here::here(
    "images",
    "readme.png"))
...
Use versioning of data files. Decide on a versioning system for yourself (we showed you an exampole before, but you are free to look for other options), an stick to it.
