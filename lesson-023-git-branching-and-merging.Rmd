...
Clearly, if you are working together with other persons, the workflow presented previously is to simple and can give rise to conflicts. Fortunately, Git offers additional tools for working together. 
...
c) In RStudio, change to the main branch. What happens to your recent changes in your RMarkdown file?
</div>
...
a) - 
b) 
c) The changes disappear, because the changes are only present in the development branch and not in the main branch. 
</details>
