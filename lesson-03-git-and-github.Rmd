...
The first time you push commits to GitHub from a repository in RStudio, you will be prompted for your user name and password. Likely, Rstudio will save your credentials, so that you will not have to enter them again. If it doesn't, do the following:

<mark> XXX  Wat is ook al weer die linux code hiervoor? Bas? </mark>

git config --global user.email "you@example.com"
git config --global user.name "Your Name"

<mark>  Of moet daar nog password bij? </mark>
...
(B)
Now start building your [CV](https://resumegenius.com/blog/resume-help/one-page-resume) in a new Rmarkdown file and keep using github for version control. Remember to commit often, and push your changes! Build something that you would want to sent to a possible future bioinformatics internship position, or when job hunting. So it needs to be complete and professional looking.
