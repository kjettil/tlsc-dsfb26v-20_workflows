# Lesson 4 - Git Branching and Merging {#gitbranchmerge}
...
Github collaborating can be tricky and you will be messing around in github today. While you can most of the time recover previous work, you will want to have the peace of mind that you won't lose anything while learning. Please really take the oppertunity to try and see what happens if you mess things up while working with 2 people on the same repo, and see if you can fix it.
...
Use the Git repository that you created in the first exercise of the Lesson 3 here: \@ref(thisrepo) (the repository with the markdown file). 
...
**Dagopdracht: projecticum repository**
