...
To complete this exercise, you need to complete the following steps:
 ...
 1. Create at least 2 milestones for the first sprint of your projecticum project (*note: if you find you have little issues to solve yet for the projecticum, you can do this exercise with your portfolio repository instead.*)
...
**Github documentation**
 ...
 C) Use the repo within the projecticum organisation, Link this repo to the project you just created. 

 D) Fill your backlog with all the tasks that you forsee in the projecticum. Devide them into smalle tasks: at most an estimated 8 hours of work per task. 
 
 E) Set the tasks for the coming sprint of 2 weeks.

</div>


<div class = "dagopdracht">
This lesson has no portfolio assignment. The nexercises within this lesson of course help build your portfolio.
</div>
