...
## Inclusing images
There are basically two ways to include an image from an existing file:

In an R-chunk call `knitr::include_graphics()`
```
...
The advantage of this approach is that you can use all the chunk options for this code chunk, controlling e.g. the size and behaviour of the image as you would normally do for a code-generated 
