...
## Lesson Contents
 ...
 - RMarkdown arameters (params in yaml header, params in chunks)
...
The aim of this assignment is to create an RMardown file containing a pramterized report for the COVID-19 cases as can be downloaded from the ECDC. The Rmd should include at least three parameters:
...
The minimum requirements for the report is that next to the three paramters mentioned above, it should include at least one graph for the COVID-19 cases and one graph for the COVID-19 related deaths. 
...
Here are some pointers to get your started:
 ...
 1. Start by downloading and exploring the data
