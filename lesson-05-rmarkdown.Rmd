...
`bibliography: "'A'"` (don't copy paste, use the slanted single ticks around A, as it is going to be R code)

but replace A with :

r rbbt::bbt_write_bib('bibliography.json', overwrite = TRUE)
