...
In this lesson we will focus a bit more on RMarkdown, as it offers a reproducible pathway from data to analysis to communication. Keep the following things in mind when starting an RMarkdown file:
  ...
  - Do everything within your .Rmd file. Don't export data, change some numbers in Excel en load them back in. This is breaking the reproducible workflow. If you find a mistake in the raw data, fix it within the .Rmd and provide a comment explaining what you are doing.
...
Test your figure [here](https://www.color-blindness.com/coblis-color-blindness-simulator/) (Take a screenshot and upload the screenshot to this website.)
</div>
...
<!-- I should switch to Zotero now that Mendeley is owned by Elsevier :/ I will update when I have time.  -->
