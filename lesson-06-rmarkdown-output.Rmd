...
Basically, if you think "Hey, I have this ggplot graph and it is nice, but it could be clearer if it had osme interactive options..." take a look at the [plotly examples here](https://plotly.com/r/). It is also rather usefull when you want subplots in your figure, like this:
