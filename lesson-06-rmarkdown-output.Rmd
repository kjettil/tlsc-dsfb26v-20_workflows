...
To start with bookdown, there is a [good and free resource available](https://bookdown.org/yihui/bookdown/get-started.html). 
 ...
 - follow the steps in the link and render the book.
 - 

</div>

A bookdown book will consist of different chapters, each in their own .Rmd file (this is why you had to do this for your portfolio). The home page, or firrst page, is always index.Rmd, which contains the YAML header.
...
Filenames that start with an underscore are skipped (in case you want to include files in the repo but not in the book for some reason).
