...
````
```{r, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center", fig.cap = "Cut and price of diamonds"}`r ''`
...
```{r, echo=FALSE, fig.height = 5, fig.width = 7, fig.align = "center", fig.cap = "Cut and price of diamonds"}
#install.packages("ggridges")
#install.packages("viridis")
#install.packages("ggthemes")
library(viridis)
...
````
```{r, fig.width = 4, fig.height = 4, echo=FALSE}`r ''`
ggplot(mpg, aes(displ, hwy, color = class)) + 
  geom_point() 
```
````
