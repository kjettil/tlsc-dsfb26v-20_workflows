...
We have met metadata before (\@ref(metadata1)).

<mark> XXX </mark>

### Reminder reproducible research
<mark> XXX </mark>
...
### What do we need for reproducing a result?
...
Which information would you need to have if you want to reproduce this figure?
</div>
...
<details><summary>Click for the answer</summary>
  ...
  1. The code
    - readable
    - comments/documentation so that you can figure out what the code does
    - what / why choices were made 
    - what software was used
  1. Metadata!
  
</details>

We have discussed code quite extensively by now. We discussed data file management in lesson 2. But what about metadata?
